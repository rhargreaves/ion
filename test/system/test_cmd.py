...
@pytest.mark.asyncio
async def test_displays_help(help_flag):
    result = await run_server_custom_args([help_flag])
...
@pytest.mark.asyncio
async def test_displays_version(version_flag):
    result = await run_server_custom_args([version_flag])
